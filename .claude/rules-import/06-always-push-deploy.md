...
**STEP 2:** If a deploy target is configured ({{DEPLOY_TARGET}}, set during onboarding Phase 4 if the owner runs always-on services), deploy any changed service code per the deploy command documented in `docs/connectors/`.
